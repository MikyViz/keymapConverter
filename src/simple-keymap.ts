/**
 * Простая альтернативная реализация конвертера раскладок
 * На основе физического расположения клавиш
 */

// Маппинг клавиш для основных раскладок
const keyMappings: { [key: string]: { en: string; ru: string; he: string } } = {
    // Верхний ряд цифр
    '1': { en: '1', ru: '1', he: '1' },
    '2': { en: '2', ru: '2', he: '2' },
    '3': { en: '3', ru: '3', he: '3' },
    ...
    // Клавиши справа от букв (буквы в RU/HE, но знаки в EN)
    '[': { en: '[', ru: 'х', he: ']' },
    ']': { en: ']', ru: 'ъ', he: '[' },
    ';': { en: ';', ru: 'ж', he: 'ף' },
    '\'': { en: '\'', ru: 'э', he: ',' },
...
export interface LayoutInspectorResult {
    char: string;
    layouts: { en: string; ru: string; he: string };
    keyDefinition?: {
        key: string;
        code: string;
    };
...
export class SimpleKeymapInspector {
    inspect(char: string): LayoutInspectorResult {
    ...
    convertText(text: string, targetLayout: 'en' | 'ru' | 'he'): string {
